        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarehouseStorages_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryForms_Users_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveredProducts_DeliveryForms_DeliveryFormId",
                        column: x => x.DeliveryFormId,
                        principalTable: "DeliveryForms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveredProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transports_Users_CarrierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveredProducts_DeliveryFormId",
                table: "DeliveredProducts",
                column: "DeliveryFormId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveredProducts_ProductId",
                table: "DeliveredProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryForms_SupplierId",
                table: "DeliveryForms",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseStorages_ProductId",
